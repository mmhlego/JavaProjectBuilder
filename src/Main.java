...
public class Main {
    String path, name, group = "mmhlego";
    ...
    public void chooseFolder() {
        ...
        path = selector.getSelectedFile().toString() + "\\";
    }

    public void projectName() {
        Scanner input = new Scanner(System.in);
        System.out.print("Please enter your projects name: ");
        name = input.nextLine();
        path += name;
        input.close();
    }
    ...
    public void createPom() {
        ...
        try {
            ...
            writer.println("\t<artifactId>" + name + "</artifactId>");
    ...
    public void openProject() {
        try {
            Runtime.getRuntime().exec("cmd /c code .", null, new File(path));
        } catch (Exception e) {
            System.out.println(e.toString());
        }
    }
